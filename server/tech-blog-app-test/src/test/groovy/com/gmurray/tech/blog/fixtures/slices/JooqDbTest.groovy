...
import com.gmurray.tech.blog.shared.infrastructure.config.persistence.jooq.JooqPersistenceConfig
...
@ComponentScan(basePackages = [
    ...
    "com.gmurray.tech.blog.shared.infrastructure.config.persistence.jooq",
    "com.gmurray.tech.blog.fixtures.persistence"
])
@ImportAutoConfiguration(classes = [FlywayAutoConfiguration.class])
@Import([JooqPersistenceConfig.class,DatabaseSliceMockConfiguration.class])
@interface JooqDbTest {

}

@Configuration
class DatabaseSliceMockConfiguration {
