...
open class BlogPostRecord() : UpdatableRecordImpl<BlogPostRecord>(BlogPost.BLOG_POST), TechBlogAuditableAwareRecord, Record11<Long?, Long?, String?, String?, String?, BlogPostStatus?, Int?, String?, LocalDateTime?, String?, LocalDateTime?>, IBlogPost {
    ...
    open override var tags: String?
        set(value): Unit = set(4, value)
        get(): String? = get(4) as String?

    open override var status: BlogPostStatus?
        set(value): Unit = set(5, value)
        get(): BlogPostStatus? = get(5) as BlogPostStatus?
    ...
    override fun valuesRow(): Row11<Long?, Long?, String?, String?, String?, BlogPostStatus?, Int?, String?, LocalDateTime?, String?, LocalDateTime?> = super.valuesRow() as Row11<Long?, Long?, String?, String?, String?, BlogPostStatus?, Int?, String?, LocalDateTime?, String?, LocalDateTime?>
    ...
    override fun field5(): Field<String?> = BlogPost.BLOG_POST.TAGS
    override fun field6(): Field<BlogPostStatus?> = BlogPost.BLOG_POST.STATUS
    override fun field7(): Field<Int?> = BlogPost.BLOG_POST.ROW_VERSION
    override fun field8(): Field<String?> = BlogPost.BLOG_POST.ROW_CREATED_BY
    override fun field9(): Field<LocalDateTime?> = BlogPost.BLOG_POST.ROW_CREATED_ON
    override fun field10(): Field<String?> = BlogPost.BLOG_POST.ROW_UPDATED_BY
    override fun field11(): Field<LocalDateTime?> = BlogPost.BLOG_POST.ROW_UPDATED_ON
    ...
    override fun component5(): String? = tags
    override fun component6(): BlogPostStatus? = status
    ...
    override fun value5(): String? = tags
    override fun value6(): BlogPostStatus? = status
    ...
    override fun value5(value: String?): BlogPostRecord {
        set(4, value)
        return this
    }

    override fun value6(value: BlogPostStatus?): BlogPostRecord {
        set(5, value)
        return this
    }

    override fun value7(value: Int?): BlogPostRecord {
        set(6, value)
        return this
    }

    override fun value8(value: String?): BlogPostRecord {
        set(7, value)
        return this
    }

    override fun value9(value: LocalDateTime?): BlogPostRecord {
        set(8, value)
        return this
    }

    override fun value10(value: String?): BlogPostRecord {
        set(9, value)
        return this
    }

    override fun value11(value: LocalDateTime?): BlogPostRecord {
        set(10, value)
        return this
    }

    override fun values(value1: Long?, value2: Long?, value3: String?, value4: String?, value5: String?, value6: BlogPostStatus?, value7: Int?, value8: String?, value9: LocalDateTime?, value10: String?, value11: LocalDateTime?): BlogPostRecord {
        this.value1(value1)
        this.value2(value2)
        this.value3(value3)
        this.value4(value4)
     ...
     */
    constructor(id: Long? = null, authorId: Long? = null, title: String? = null, description: String? = null, tags: String? = null, status: BlogPostStatus? = null, rowVersion: Int? = null, rowCreatedBy: String? = null, rowCreatedOn: LocalDateTime? = null, rowUpdatedBy: String? = null, rowUpdatedOn: LocalDateTime? = null): this() {
        this.id = id
